...
QT_MOC_LITERAL(1, 10, 11), // "dealMessage"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "char*"
QT_MOC_LITERAL(4, 29, 6) // "buffer"

    },
    "TcpSocket\0dealMessage\0\0char*\0buffer"
};
...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dealMessage((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (TcpSocket::*_t)(char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TcpSocket::dealMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TcpSocket::dealMessage(char * _t1)
{
