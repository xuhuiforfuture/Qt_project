...
QT_MOC_LITERAL(1, 11, 14), // "sigDealMessage"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "ecg1"
QT_MOC_LITERAL(4, 32, 4), // "ecg2"
QT_MOC_LITERAL(5, 37, 4), // "ecg3"
QT_MOC_LITERAL(6, 42, 12), // "storeMessage"
QT_MOC_LITERAL(7, 55, 11) // "readMessage"

    },
    "SerialPort\0sigDealMessage\0\0ecg1\0ecg2\0"
    "ecg3\0storeMessage\0readMessage"
};
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigDealMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->storeMessage((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (SerialPort::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPort::sigDealMessage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SerialPort::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialPort::storeMessage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SerialPort::sigDealMessage(int _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void SerialPort::storeMessage(int _t1, int _t2, int _t3)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)), const_cast<void*>(reinterpret_cast<const void*>(&_t3)) };
