...
bool DataBase::selectDeviceBySerial(QString Serial, QString password)
{
    bool ret = true;
...
bool DataBase::insertDeviceBySerial(QString Serial, QString password)
{
    bool ret = true;
    ...
    QString sql = "insert into device values(null, :str1, :str2, datetime('now','localtime'));";
    QSqlQuery query(db);
    query.prepare(sql);
    query.bindValue(":str1", QVariant(Serial));
...
bool DataBase::insertEcgWaveData(QString serial, QByteArray ba)
{
    bool ret = true;
    ...
    QString sql = "insert into EcgWaveData values(null, :serial, :ecgData, datetime('now', 'localtime'));";
    QSqlQuery query(db);
    query.prepare(sql);
    query.bindValue(":serial", QVariant(serial));
